...
const DOM = {
    ...
    content: document.querySelector('#u-sneaky-little-dev'),
...
export class Intro {
    ...
    setup() {
        ...
        // hide on start
        gsap.set([this.DOM.circleText, DOM.content], {opacity: 0});
    ...
    initEvents() {
        ...
        this.enterMouseEnterEv = () => {
            ...
            gsap.to(DOM.enterBackground, {
                duration: 0.8, ease: 'power4', scale: 1.2, opacity: 1
            });

            gsap.to(this.DOM.circleText, {
                duration: 4, ease: 'power4', rotate: '+=180', stagger: {
                    amount: -0.3
                }
            });
        };
        this.enterMouseLeaveEv = () => {
            ...
            gsap.to(DOM.enterBackground, {
                duration: 0.8, ease: 'power4', scale: 1
            });
        };
    ...
    start() {
        this.startTL = gsap.timeline()
            ...
            .to([this.DOM.circleText, DOM.enterCtrl], {
                duration: 2.5, ease: 'expo', startAt: {opacity: 0, scale: 0.3}, scale: 1, opacity: 1, stagger: {
                    amount: 0.5
                }
            }, 'start')
    ...
    enter() {
        ...
        gsap.timeline()
            .addLabel('start', 0)
            .to([DOM.content.children], {opacity: 0, duration: 0})
            .to(DOM.enterCtrl, {
                duration: 1.5, ease: 'expo.inOut', scale: 0.7, opacity: 0
            }, 'start')
            ...
            .to([DOM.content.children], {
                duration: 1, ease: 'power3.out', startAt: {opacity: 0, scale: 0.9}, scale: 1, opacity: 1, stagger: {
                    amount: 0.3
                }
            }, 'start+=1.1')
    }
